...
export class CommentsService {
  ...
  async createComment(createCommentDto: Partial<Comment>): Promise<Comment> {
  ...
  async updateComment(id: string, updateCommentDto: Partial<Comment>): Promise<Comment | null> {
